...
var Annotations, ArrayInitialiser, Block, Bool, Class, CompoundAssignOp, ComputedProperty, concat, concatMap, Conditional, createNodes, difference, enumerableMethods, exports, ForOf, FunctionApplications, Functions, GenSym, handleLists, handlePrimitives, HeregExp, Identifier, Identifiers, map, MemberAccessOp, Mixin, NegatedConditional, NewOp, Nodes, nub, ObjectInitialiser, ObjectInitialiserMember, PostDecrementOp, PostIncrementOp, Primitives, Range, RegExp, RegExps, Slice, StaticMemberAccessOps, Super, Switch, SwitchCase, This, union, While;
...
Nodes.prototype.dependentKeys = function () {
...
This.prototype.dependentKeys = function () {
  return [[]];
};
MemberAccessOp.prototype.dependentKeys = function () {
  var memberName;
  memberName = this.memberName;
  return this.expression.dependentKeys().map(function (c) {
    c.push(memberName);
    return c;
  });
};
...
FunctionApplications.prototype.dependentKeys = function () {
  var res;
  res = this['function'].dependentKeys();
