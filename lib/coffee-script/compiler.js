  ...
  defaultRules = [
    [
      ...
      CS.Switch, function(_arg) {
        var alternate, c, cases, expression, _i, _j, _len, _len1, _ref3, _ref4;
        ...
        for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
          c = _ref3[_j];
          if (((_ref4 = c.consequent) != null ? _ref4.length : void 0) > 0) {
      ...
      CS.SwitchCase, function(_arg) {
        ...
        block = block != null ? block["instanceof"](JS.BlockStatement) ? block.body : [block] : [];
      ...
      CS.Class, function(_arg) {
        var args, block, body, compile, ctor, ctorRef, iife, instance, member, memberName, mixinArgs, name, nameAssignee, params, parent, parentExpr, parentRef, protoAssignOp, protoMember, ps, rewriteThis, _, _i, _len, _ref3;
        ...
        if (this.boundMembers.length > 0) {
          ...
          _ref3 = this.boundMembers;
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            protoAssignOp = _ref3[_i];
            memberName = protoAssignOp.assignee.data.toString();
            ps = (function() {
              var _j, _len1, _ref4, _results;
              _ref4 = protoAssignOp.expression.parameters;
              _results = [];
              for (_j = 0, _len1 = _ref4.length; _j < _len1; _j++) {
                _ = _ref4[_j];
        ...
        rewriteThis(block);
        mixinArgs = this.mixins.map(function(mixin) {
          return new JS.Identifier(mixin);
        });
        parentExpr = (parent != null ? parent.name : void 0) ? new JS.Identifier(parent.name) : memberAccess(new JS.Identifier('Ember'), 'Object');
      ...
      CS.ChainedComparisonOp, function(_arg) {
        var compile, expression, left, lhs;
          ...
          switch (right.elements.length) {
            case 0:
              if (needsCaching(this.left)) {
                return new JS.SequenceExpression([left, new JS.Literal(false)]);
              } else {
