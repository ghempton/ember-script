...
var CS, JS, any, beingDeclared, collectIdentifiers, concat, concatMap, declarationsNeededFor, difference, divMod, dynamicMemberAccess, enabledHelpers, envEnrichments, exports, expr, fn, foldl1, forceBlock, genSym, generateMutatingWalker, h, helperNames, helpers, inlineHelpers, jsReserved, makeReturn, makeVarDeclaration, map, memberAccess, needsCaching, nub, owns, stmt, union, usedAsExpression, _ref, _ref1, _ref2,
  __slice = [].slice,
  ...
  defaultRules = [
    [
      ...
      CS.Function, function(_arg) {
        var ancestry, block, last, parameters, _ref3;
      ...
      CS.BoundFunction, function(_arg) {
        var ancestry, block, last, newThis, parameters, performedRewrite, rewriteThis, _ref3;
        parameters = _arg.parameters, block = _arg.block, ancestry = _arg.ancestry;
        if (!((_ref3 = ancestry[0]) != null ? _ref3["instanceof"](CS.Constructor) : void 0)) {
          block = makeReturn(block);
        }
      ...
      CS.Class, function(_arg) {
        var args, block, compile, ctor, ctorRef, iife, mixinArgs, name, nameAssignee, params, parent, parentExpr, parentRef, rewriteThis;
        ...
        if ((this.ctor != null) && !this.ctor.expression["instanceof"](CS.Functions)) {
          ...
          block.body.unshift(stmt(new JS.AssignmentExpression('=', ctorRef, compile(this.ctor.expression))));
        }
