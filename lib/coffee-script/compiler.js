...
emberGet = function (e, member) {
  return new JS.CallExpression(memberAccess(new JS.Identifier('Ember'), 'get'), [
    e,
    new JS.Literal(member)
  ]);
};
...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      ...
      function (param$) {
        var annotation, cache$2, expression, key;
        {
          cache$2 = param$;
          key = cache$2.key;
          expression = cache$2.expression;
        ...
        for (var i$ = 0, length$ = this.annotations.length; i$ < length$; ++i$) {
    ...
    [
      ...
      function (param$) {
        ...
        extendArgs = this.mixins.map(function (mixin) {
          return new JS.Identifier(mixin);
        });
        if (body)
          extendArgs.push(body);
        parentExpr = (null != parent ? parent.name : void 0) ? new JS.Identifier(parent.name) : memberAccess(new JS.Identifier('Ember'), 'Object');
    ...
    [
      ...
      function (param$) {
        ...
        } else if (this.isAssignment || this.isFunctionContext || expression['instanceof'](JS.Literal) || parent['instanceof'](CS.DeleteOp)) {
          return memberAccess(expression, this.memberName);
        } else {
          return emberGet(expression, this.memberName);
        }
      }
    ],
    [
