...
exports.Compiler = function () {
  ...
  defaultRules = [
    ...
    [
      ...
      function (param$) {
        var ancestry, cache$2, compile, expression, i, n;
        {
          cache$2 = param$;
          expression = cache$2.expression;
          compile = cache$2.compile;
        ...
        if (hasSoak(this)) {
          ...
          for (var i$ = 0, length$ = ancestry.length; i$ < length$; ++i$) {
            n = ancestry[i$];
            i = i$;
            if (n instanceof CS.MemberAccessOps)
              break;
            if (n instanceof CS.AssignOps || n['instanceof'](CS.FunctionApplication))
