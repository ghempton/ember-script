...
var ArrayInitialiser, Block, Bool, Class, CompoundAssignOp, Conditional, ForOf, FunctionApplications, Functions, GenSym, HeregExp, Identifier, Identifiers, Mixin, NegatedConditional, NewOp, Nodes, ObjectInitialiser, Primitives, Range, RegExp, RegExps, Slice, StaticMemberAccessOps, Super, Switch, SwitchCase, While, concat, concatMap, createNodes, difference, exports, handleLists, handlePrimitives, map, nub, union, _ref, _ref1,
...
createNodes({
  Nodes: [
    [], {
      ...
      Mixin: [['nameAssignee', 'body', 'mixins']],
      Class: [['nameAssignee', 'parent', 'ctor', 'body', 'boundMembers', 'mixins']],
