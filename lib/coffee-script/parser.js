  ...
  var result = {
    ...
    parse: function(input) {
                    ...
                    if (r0 === null) {
                      ...
                      if (r0 === null) {
                        ...
                        if (r0 === null) {
                          ...
                          if (r0 !== null) {
                            r0 = (function(offset, line, column, ws, e) { return {op: CS.NativeMemberAccessOp, operands: [e], raw: '*.' + ws + e, line: line, column: column, offset: offset}; })(r1.offset, r1.line, r1.column, r4, r5);
                          }
                          if (r0 === null) {
                            pos = clone(r1);
                          }
      ...
      function parse_mixin() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, name, mixins, body) {
            raw = 'mixin'; // TODO
      ...
      function parse_mixinBody() {
        var cacheKey = "mixinBody@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (r0 === null) {
          ...
          if (r0 !== null) {
            r0 = (function(offset, line, column, t, body, d) {
              return body;
            })(r1.offset, r1.line, r1.column, r3, r4, r5);
          }
          if (r0 === null) {
        ...
        if (r3 !== null) {
          ...
          if (r7 !== null) {
            ...
            if (r8 !== null) {
              r9 = parse__();
              if (r9 !== null) {
                r10 = parse_classProtoAssignment();
                if (r10 !== null) {
                  r5 = [r7, r8, r9, r10];
                } else {
                  r5 = null;
      ...
      function parse_annotation() {
        ...
        if (r3 !== null) {
          r4 = parse__();
          if (r4 !== null) {
            if (input.substr(pos.offset, 8) === "computed") {
              r5 = "computed";
              advance(pos, 8);
            } else {
              r5 = null;
            ...
            if (r5 === null) {
              if (input.substr(pos.offset, 8) === "observer") {
                r5 = "observer";
                advance(pos, 8);
              } else {
                r5 = null;
              ...
              if (r5 === null) {
                if (input.substr(pos.offset, 8) === "volatile") {
                  r5 = "volatile";
                  advance(pos, 8);
                } else {
                  r5 = null;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, ws1, name, params, t, ws2) {
      ...
      function parse_objectLiteralMember() {
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, annotations, key, ws0, ws1, val) {
      ...
      function parse_memberAssign() {
        var cacheKey = "memberAssign@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
        ...
        if (r0 !== null) {
          r0 = (function(offset, line, column, access) { access.isAssignment = true; return access })(r1.offset, r1.line, r1.column, r0);
        }
        if (r0 === null) {
          pos = clone(r1);
        }
      ...
      function parse_contextAssign() {
        var cacheKey = "contextAssign@" + pos.offset;
        var cachedResult = cache[cacheKey];
        if (cachedResult) {
          pos = clone(cachedResult.nextPos);
          return cachedResult.result;
