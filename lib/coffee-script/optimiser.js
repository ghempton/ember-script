...
mayHaveSideEffects = makeDispatcher(false, [
  [
    ...
    [CS.DoOp], function(inScope) {
      ...
      return mayHaveSideEffects(this.expression.block, newScope);
    }
  ], [
    ...
    [
      ...
      CS.While, function(inScope) {
        if (isFalsey(this.condition)) {
          return new CS.Block([mayHaveSideEffects(this.condition, inScope) ? new CS.SeqOp(this.condition, declarationsFor(this.block)) : typeof block !== "undefined" && block !== null ? declarationsFor(this.block, inScope) : new CS.Undefined, new CS.ArrayInitialiser([])]);
      ...
      CS.ForOf, function(inScope, ancestors) {
        if (!(this.isOwn && (this.expression["instanceof"](CS.ObjectInitialiser)) && this.expression.members.length === 0)) {
          return this;
        }
        return new CS.SeqOp(declarationsFor(this, inScope), (new CS.ArrayInitialiser([])).g());
      }
      ...
      CS.ForIn, function() {
        if (!isTruthy(this.filterExpr)) {
          return this;
        }
        return new CS.ForIn(this.valAssignee, this.keyAssignee, this.expression, this.step, null, this.block);
      }
    ], [
      CS.ForOf, function() {
        if (!isTruthy(this.filterExpr)) {
        ...
        return new CS.ForOf(this.isOwn, this.keyAssignee, this.valAssignee, this.expression, null, this.block);
      }
    ], [
      ...
      CS.SeqOp, function(_, ancestors) {
        var _ref3;
        if (!((_ref3 = ancestors[0]) != null ? _ref3["instanceof"](CS.Functions) : void 0)) {
          return this;
        }
